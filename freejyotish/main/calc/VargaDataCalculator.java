	...
	private static int[][] calculateAllVargaPositions(AllPlanets allPlanets)
	{
			...
			switch(varga)
			{
				case 0:
					...
					{	
						vargaDataArray[0][i] = getRasi(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 1:
					...
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[1][i] =  getHora(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 2:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[2][i] = getDrekkana(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 3:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[3][i] = getChaturtamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 4:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[4][i] = getPanchamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 5:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[5][i] = getSaptamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 6:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[6][i] = getAshtamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 7:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[7][i] = getNavamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 8:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[8][i] = getDasamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 9:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[9][i] = getDwadasamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 10:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[10][i] = getShodasamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 11:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[11][i] = getVimshamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 12:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[12][i] = getSiddhamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 13:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[13][i] = getBhamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 14:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[14][i] = getTrimshamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 15:
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[15][i] = getKhavedamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 16:
					...
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[16][i] = getAkshvedamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
				...
				case 17:
					...
					for(int i = 0; i<allPlanets.getSize(); i++)
					{	
						vargaDataArray[17][i] = getShastiamsa(allPlanets.getPlanet(FJConstants.planetLongNames[i]).getLongitude());
