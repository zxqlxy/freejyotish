...
1.2
date	2003.05.24.01.30.19;	author michaeltaft;	state Exp;
branches;
next	1.1;
...
public class FJUtility
{
	...
	public static String DegToSign(double degrees, int sign)
	{
		...
		return new String(deg + "°" + FJConstants.zodiacShortNames[sign] + min + "'" + sec);
	}
	...
	{
		int i = 0;
		while ((temp -= FJConstants.nakshatraDeg) > 0)
		{
			i++;
		}
		return FJConstants.nakshatra[i];
	}
